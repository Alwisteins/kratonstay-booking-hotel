  ...
  return (
    <section className="w-full bg-[#FAFAF7] dark:bg-black py-20">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="rounded-2xl bg-white dark:bg-slate-900 shadow-lg">
          <div className="grid grid-cols-1 gap-6 p-6 md:grid-cols-3">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h3 className="mb-4 text-lg font-semibold text-green-900 dark:text-green-600">
                  Nearby Attractions
                </h3>
              ...
              <button>
                <a
                  ...
                  target="_blank"
                  className="mt-6 inline-flex w-full items-center justify-center rounded-lg border border-gray-300 px-4 py-3 text-sm font-medium text-gray-800 dark:text-gray-300 transition hover:bg-gray-100 dark:hover:bg-gray-800">
                  Get Directions
                </a>
              </button>
            </div>
